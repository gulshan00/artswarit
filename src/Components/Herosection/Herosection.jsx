...
// import { Search, MapPin, Mail, Link2, X } from 'lucide-react';
...
//   return (
//     <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
//       <div className="bg-white rounded-lg w-full max-w-xl mx-auto relative">
//         <button
//           onClick={onClose}
...
//       website: "www.sarahart.com",
//       bio: "Contemporary artist specializing in abstract expressionism with over 10 years of experience in the field.",
...
//       website: "www.emilychen.art",
//       bio: "Digital artist and illustrator creating vibrant worlds through digital media and traditional techniques.",
...
//       website: "www.mariaart.com",
//       bio: "Photography artist capturing the essence of urban life and natural landscapes.",
//       specialties: ["Photography", "Street Art", "Landscape"]
//     }
//   ];
...
//       <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
//         <div
//           className="rounded-xl overflow-hidden shadow-lg col-span-1 relative group cursor-pointer transform transition-all duration-300 hover:scale-105"
//           onMouseEnter={() => setHoveredCard(0)}
//           onMouseLeave={() => setHoveredCard(null)}
//           onClick={() => setIsModalOpen(true)}
//         >
//           <img
//             src={artistProfiles[0].image}
//             alt={artistProfiles[0].name}
//             className="w-full h-full object-cover"
//           />
//           <div className={`absolute inset-0 bg-black transition-opacity duration-300 ${hoveredCard === 0 ? 'bg-opacity-50' : 'bg-opacity-0'}`}>
//             <div className={`absolute inset-0 flex flex-col justify-center items-center p-4 transition-opacity duration-300 ${hoveredCard === 0 ? 'opacity-100' : 'opacity-0'}`}>
//               <h3 className="text-xl md:text-2xl font-bold mb-2">{artistProfiles[0].name}</h3>
//               <button className="bg-white text-purple-600 px-4 py-2 rounded-lg font-semibold hover:bg-gray-100 transition-colors duration-200">
//                 View Profile
//               </button>
//             </div>
//           </div>
...
//         <div className="rounded-xl overflow-hidden shadow-lg bg-gray-800 col-span-1 md:col-span-2 flex flex-col md:flex-row">
//           <div
//             className="relative w-full md:w-1/2 group cursor-pointer transform transition-all duration-300 hover:scale-105"
//             onMouseEnter={() => setHoveredCard(1)}
//             onMouseLeave={() => setHoveredCard(null)}
//             onClick={() => setIsModalOpen(true)}
//           >
//             <img
//               src={artistProfiles[1].image}
//               alt={artistProfiles[1].name}
//               className="w-full h-full object-cover"
//             />
//             <div className={`absolute inset-0 bg-black transition-opacity duration-300 ${hoveredCard === 1 ? 'bg-opacity-50' : 'bg-opacity-30'}`}>
//               <div className={`absolute inset-0 flex flex-col justify-center items-center p-4 transition-opacity duration-300 ${hoveredCard === 1 ? 'opacity-100' : 'opacity-0'}`}>
//                 <h3 className="text-xl md:text-2xl font-bold mb-2">{artistProfiles[1].name}</h3>
//                 <button className="bg-white text-purple-600 px-4 py-2 rounded-lg font-semibold hover:bg-gray-100 transition-colors duration-200">
//                   View Profile
//                 </button>
//               </div>
...
//           >
//             <img
//               src={artistProfiles[2].image}
//               alt={artistProfiles[2].name}
//               className="w-full h-full object-cover"
//             />
//             <div className={`absolute inset-0 bg-black transition-opacity duration-300 ${hoveredCard === 2 ? 'bg-opacity-50' : 'bg-opacity-0'}`}>
//               <div className={`absolute inset-0 flex flex-col justify-center items-center p-4 transition-opacity duration-300 ${hoveredCard === 2 ? 'opacity-100' : 'opacity-0'}`}>
//                 <h3 className="text-xl md:text-2xl font-bold mb-2">{artistProfiles[2].name}</h3>
//                 <button className="bg-white text-purple-600 px-4 py-2 rounded-lg font-semibold hover:bg-gray-100 transition-colors duration-200">
//                   View Profile
//                 </button>
//               </div>
...
//       <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
//         <div className="p-6">
//           <h2 className="text-2xl font-bold text-gray-900 mb-4">Artist Profile</h2>
//           <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
...
//                   {artistProfiles[1].name}
//                 </h3>
//                 <p className="text-gray-600 mb-4">{artistProfiles[1].bio}</p>
//                 <div className="space-y-2">
//                   <div className="flex items-center text-gray-600">
//                     <MapPin className="w-4 h-4 mr-2" />
//                     <span>{artistProfiles[1].location}</span>
//                   </div>
//                   <div className="flex items-center text-gray-600">
//                     <Mail className="w-4 h-4 mr-2" />
//                     <span>{artistProfiles[1].email}</span>
//                   </div>
//                   <div className="flex items-center text-gray-600">
//                     <Link2 className="w-4 h-4 mr-2" />
//                     <span>{artistProfiles[1].website}</span>
//                   </div>
//                 </div>
//               </div>
//               <div className="mt-4">
...
//                   {artistProfiles[1].specialties.map((specialty, index) => (
//                     <span
//                       key={index}
